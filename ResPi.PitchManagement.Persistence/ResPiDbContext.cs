...
namespace ResPi.PitchManagement.Persistence
{
    public class ResPiDbContext : DbContext
    {
        public ResPiDbContext(DbContextOptions<ResPiDbContext> options)
            : base(options)
        {
        ...
        {
            modelBuilder.ApplyConfigurationsFromAssembly(typeof(ResPiDbContext).Assembly);
